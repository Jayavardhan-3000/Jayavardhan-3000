...
# ===========================================================================
HOST = "jayavardhan"   # shown as  jayavardhan@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "CSE Student, 3rd Yr @ Raghu Engg College"),
    ("kv", "Role", "Technical Co-Lead @ GFG Student Chapter"),
    ("kv", "Goal", "AI Engineer @ a MANGA-tier company"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Languages", "Python, C++, Java, C"),
    ("kv", "AI / ML", "PyTorch, LLMs, RAG, Fine-tuning (QLoRA)"),
    ("kv", "Data", "NumPy, Pandas, FAISS, ChromaDB"),
    ("kv", "Web", "Flask, REST APIs, HTML/CSS"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Built DOT, an AI study companion (Mistral-7B, QLoRA)"),
    ("bul", "Production RAG pipeline w/ multi-scale chunking"),
    ("bul", "Leads a student tech team @ GFG chapter"),
]
